	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.jsp">Smile > 后台管理</a>
        	...
        	<div id="mysidebar" class="span3">
          		<div id="tag" class="well sidebar-nav">
		            <ul class="nav nav-list">
						...
						<li><a href="adminServlet?action=findAllPapers" target="iframe">查看所有问卷</a></li>
						<li><a href="adminServlet?action=findPaper" target="iframe">问卷综合管理</a></li>
		            </ul>
          		</div><!--/.well -->
        	</div><!--/span-->
