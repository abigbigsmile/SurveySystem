...
<html>
  ...
  <%
	...
	try {
		String sql = "";
		String url = "jdbc:mysql://localhost:3306/survey?user=root&password=123456&useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=GMT%2B8";
		...
		String[] tableName = {"Users", "Papers", "Questions"};
			...
			sql = "INSERT INTO Users VALUES(NULL, 'admin', 'admin', 'admin.png', 'admin@singlex.net', '2018-08-12 12:12:12', '1', '0')";
			pstmt = conn.prepareStatement(sql);
			pstmt.executeUpdate();
			...
			sql = "INSERT INTO Papers VALUES(NULL, '1', 'Test paper', 'This is a test paper! Enjoy it!', '2018-08-12 12:00:00', '2013-05-10 12:00:00', 'default_bg.png', '1', '1', '99')";
			pstmt = conn.prepareStatement(sql);
			pstmt.executeUpdate();
